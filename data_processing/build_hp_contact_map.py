...
def get_contact_map(snapshot_dir, contact_distance, F_threshold):
    ...
    print(f"Writing contact-map-{seq1id}-size{contact_distance}-trial{trial}.dat")
    
    with open(f'{clargs.output_folder}/contact-map-{seq1id}-size{contact_distance}-trial{trial}.dat', 'w') as f:
