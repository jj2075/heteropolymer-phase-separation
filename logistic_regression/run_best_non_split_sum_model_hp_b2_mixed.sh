...
# HP contact distance cutoff used in the paper (3.0 sigma)
cutoff_distance=3.0
...
model_results_dir="/home/jj2075/heteropolymer-phase-separation/heteropolymer-phase-separation/logistic_regression/model_results/b2-rg-mean-variance/hp_b2_mixed/cutoff_${cutoff_distance}/"
